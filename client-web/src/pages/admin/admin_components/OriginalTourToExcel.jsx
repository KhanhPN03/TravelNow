...
export default async function OriginalTourToExcel(tours) {
  console.log("Exporting tours:", tours);
  ...
  worksheet.addRow([`Total tours assigned to ${date} is ${tours.length}`]);
  ...
  const filename = `OriginalTour_${formatDateForFilename()}.xlsx`;
