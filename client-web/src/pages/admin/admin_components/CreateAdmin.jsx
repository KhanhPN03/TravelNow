...
const CreateAdmin = () => {
  ...
  const validateForm = () => {
    ...
    if (!fields.DOB || !DOBRegex.test(fields.DOB)) {
      ...
      if (dob > minAgeDate) {
        newErrors.DOB = "Admin must be at least 15 years old";
      }
    }
    if (!fields.gender) {
      newErrors.gender = "Gender is required";
    }
    // Validate phone: required and must match regex
    if (!fields.phone) {
    ...
    // Debug: Log errors to check if phone error is set
    ...
    if (validateForm()) {
      try {
        ...
        if (response.data.success) {
          notify("Create new admin successfully", "success");
        ...
        notify(`${error.response?.data.message}. Please try again`, "error");
      }
    }
  };
        ...
        <div className="profileSettingsContainer">
          <form onSubmit={handleSubmit} className="tabContent ffGTBold">
            <div className="createAccount">
              ...
              <h2 className="fs20">Create New Admin</h2>
            </div>
