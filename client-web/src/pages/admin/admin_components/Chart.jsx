...
const Chart = () => {
  ...
  return (
    <div className="dashboardChartContainer">
      <Link to="/admin/dashboard" className="AdminBackButton fs-14 ffGTBold">
      ...
      <div className="chartCardContainer">
        <div className="chartCard">
          <div className="titleAndDate">
            <span className="titleChart ffGTBold fs-16">Total Revenue</span>
            ...
            <div className="chartCardHeader">
              <div className="revenueInfo">
                <div className="amountChart">
                  <span className="dollar ffGTBold">$</span>
            ...
            {/* <PieChart width={84} height={84}>
                            ...
                            >
                                {adventureData.map((entry, index) => (
                                    <Cell key={`cell-${index}`} fill={PASTEL_COLORS.adventure[index]} />
                                ))}
                            </Pie>
                        </PieChart> */}
          </div>
            ...
            {/* <PieChart width={84} height={84}>
                            ...
                            >
                                {longTripData.map((entry, index) => (
                                    <Cell key={`cell-${index}`} fill={PASTEL_COLORS.longTrip[index]} />
                                ))}
                            </Pie>
                        </PieChart> */}
          </div>
